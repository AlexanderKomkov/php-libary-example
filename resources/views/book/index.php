...
<div class="container my-5">
    <h1>Книги</h1>
    <a href="/books/create" class="btn btn-success mb-5 mt-2">Добавить книгу</a>
    <div class="col-lg-11 px-0">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><?=$book['count']?> шт.</td>
                <td>
                    <a href="<?='/books/' . $book['id']?>" type="button" class="btn btn-primary">Просмотр</a>
                </td>
                <td>
                    <a href="<?='/books/' . $book['id'] . '/edit'?>" type="button" class="btn btn-success">Редактировать</a>
                </td>
                <td>
        ...
        <p>В настоящий момент, к сожалению, книг в библиотеке нет.</p>
