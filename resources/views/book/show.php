...
<head>
    ...
    <title>Просмотр книги - Библиотека</title>
...
<div class="container my-5">
    ...
    <div class="col-lg-8 px-0">
        ...
        ?>
        <p>Жанры: <?=implode(', ', $genres)?></p>
        <p>
            <a href="<?='/books/' . $book['id'] . '/edit'?>" type="button" class="btn btn-primary">Редактировать</a>
        </p>
