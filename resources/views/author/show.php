...
<head>
    ...
    <title>Просмотр автора - Библиотека</title>
...
<div class="container my-5">
    <h1>Просмотр автора #<?=$author['id']?></h1>
    <a href="/authors" class="btn btn-success mb-5 mt-2">Назад к списку авторов</a>
    <div class="col-lg-8 px-0">
        <p>Имя: <?=$author['first_name']?></p>
        <p>Фамилия: <?=$author['last_name']?></p>
        <p>
            <a href="<?='/authors/' . $author['id'] . '/edit'?>" type="button" class="btn btn-primary">Редактировать</a>
        </p>
