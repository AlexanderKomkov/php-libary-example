...
<head>
    ...
    <title>Просмотр пользователя - Библиотека</title>
...
<div class="container my-5">
    <h1>Просмотр пользователя #<?=$user['id']?></h1>
    ...
    <div class="col-lg-8 px-0">
        ...
        <p>
            <a href="<?='/users/' . $user['id'] . '/edit'?>" type="button" class="btn btn-primary">Редактировать</a>
        </p>
