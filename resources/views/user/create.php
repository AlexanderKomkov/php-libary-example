...
<head>
    ...
    <title>Добавление пользователя - Библиотека</title>
...
<div class="container my-5">
    ...
    <a href="/users" class="btn btn-success mb-5 mt-2">Назад к списку пользователей</a>
    <div class="col-lg-8 px-0">
        ...
        <form action="/users" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="password" id="inputPassword" name="password" class="form-control" aria-labelledby="passwordHelpBlock" required>
